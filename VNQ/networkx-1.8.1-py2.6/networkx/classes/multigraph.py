...
class MultiGraph(Graph):
    ...
    **Shortcuts:**
    ...
    Many common graph features allow python syntax to speed reporting.py.
    ...
    **Reporting:**
    ...
    Iterator versions of many reporting.py methods exist for efficiency.
    Methods exist for reporting.py nodes(), edges(), neighbors() and degree()
