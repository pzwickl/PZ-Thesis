...
class GEXFWriter(GEXF):
    ...
    def add_nodes(self, G, graph_element):
        ...
        graph_element.add(nodes_element)
    ...
    def add_edges(self, G, graph_element):
        ...
        graph_element.add(edges_element)
    ...
    def add_parents(self,node_element,node_data):
        ...
        if parents:
            ...
            node_element.add(parents_element)
        return node_data
    ...
    def add_slices(self,node_element,node_data):
        ...
        if slices:
            ...
            node_element.add(slices_element)
        return node_data
    ...
    def add_spells(self,node_element,node_data):
        ...
        if spells:
            ...
            node_element.add(spells_element)
        return node_data
        ...
        if attr_element is not None:
            ...
            for a in attr_element.findall("{%s}attvalue" % self.NS_GEXF):
                ...
                if gexf_keys[key]['mode']=='dynamic':
                    ...
                    if title in attr:
                        attr[title].add((value,start,end))
                    else:
